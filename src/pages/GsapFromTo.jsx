...
const GsapFromTo = () => {
  ...
  /* Önceki durumdan sonraki duruma geçiş söz konusudur.
  Bu yüzden önceki durumun özellikleri ve sonraki
  durumun özellikleri olarak metod yazdık
  */
  useGSAP(() => {
    gsap.fromTo('#red-box' ,{
      x: 0,
    ...
    {
      x: 250,
      repeat: -1, // gidip gelmesini sağlar. Aşağıdada true diyerek.
      yoyo: true, 
      borderRadius: '100%',
      rotation: 360, // Dönme özelliği
      duration: 2, // Dönme hızını yavaşlatır.
      ease: "power1.inOut" // hareketine yeni özellikler ekledik.
    })
  }, []);
  return (
    <main>
